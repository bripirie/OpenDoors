/* EX_VOTE5.C - The files ex_vote1.c thru ex_vote5.c demonstrate the         */
...
main()
{
   ...
   strcpy(od_control.od_prog_name, "EZVote 5.00");
   ...
   for(;;)
   {
      ...
      if((chMenuChoice = od_hotkey_menu("EZVOTE", "VRADPEH", TRUE)) == 0)
      {
         /* If the EZVOTE file could not be displayed, display our own menu. */
